            ...
            <div className="p-8 space-y-12 max-w-5xl mx-auto bg-white min-h-screen shadow-lg">
                <header className="space-y-2 border-b pb-6">
                    ...
                    <p className="text-lg text-gray-600 font-light">
                        A comprehensive showcase of available components with Tailwind CSS 4.
                    </p>
                </header>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-6">
                            <div className="space-y-2">
                                <FieldLabel title="Text Field" description="Basic text input example" />
                                <TextField 
                                    value={text} 
                        ...
                        <List 
                            ...
                            items={[
                                { 
                                    ...
                                    leadingElement: <div className="p-2 bg-green-100 text-green-600 rounded-full"><LucideIcon iconName="ShoppingCart" size={16} /></div>
                                },
                                { 
                                    primary: 'Product Updated', 
                                    secondary: 'Main landing page updated',
                                    leadingElement: <div className="p-2 bg-blue-100 text-blue-600 rounded-full"><LucideIcon iconName="Edit" size={16} /></div>
                                },
                                { 
                                    primary: 'Security Alert', 
                                    secondary: 'New login from unknown device',
                                    leadingElement: <div className="p-2 bg-red-100 text-red-600 rounded-full"><LucideIcon iconName="ShieldAlert" size={16} /></div>
                                }
                            ]}
                        />
                    </div>
                ...
                <section className="space-y-6">
                    ...
                    <InfoBox 
                        ...
                        variant="info"
                    >
                        Visit our <Link href="#">documentation</Link> to learn more about how to use these components effectively in your project.
                    </InfoBox>
                </section>

                <footer className="pt-12 border-t text-center text-gray-500 text-sm">
                    <div className="test-component">
                        Tailwind 4 @theme and @apply variables test - This background should be red if override works!
                    </div>
                    <p className="mt-4">Built with @wedevs/plugin-ui and Tailwind CSS 4</p>
                </footer>
            </div>
        </div>
    );
