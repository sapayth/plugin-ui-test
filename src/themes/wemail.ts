...
/** WeMail light theme (from sample-theme.css :root) */
export const wemailTheme: ThemeTokens = {
...
/** WeMail dark theme (from sample-theme.css .dark) */
export const wemailDarkTheme: ThemeTokens = {
